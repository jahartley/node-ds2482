  ...
  */
    ...
    return new Promise((resolve, reject) => {
      ...
      if (bytes) {
       ...
       i2c.openPromisified(1).
         then(i2c1 => i2c1.writeI2cBlock(this.i2cAddress, cmd, buf.length, buf).
         then((err, resp) => (err ? reject(err) : resolve())).
         then(_ => i2c1.close())
        ).catch(console.log);       
       ...
       i2c.openPromisified(1).
         then(i2c1 => i2c1.i2cWrite(this.i2cAddress, buf.length, buf).
         then((err, resp) => ({
          console.log(err);
          console.log('up err dn resp');
          console.log(resp);
  ...
  _i2cRead() {
    return new Promise((resolve, reject) => {
      ...
      i2c.openPromisified(1).
       then(i2c1 => i2c1.i2cRead(this.i2cAddress, 1, buf).
       then((err, resp) => (err ? reject(err) : resolve(buf))).
       then(_ => i2c1.close())
      ).catch(console.log);  
    });
  }
